#!/usr/bin/env python3
"""Run the clean original-versus-isolated FACR pair on RGBNT201."""
...
CHAIN_NAME = 'E061_E062_clean_FACR_pair'
ROWS = (
    (
        'E061',
        'A2-FACR-CLEAN',
        'configs/RGBNT201/ablations/t14_chain/a2_facr.yml',
        'E061_A2_facr_clean_RGBNT201_seed1111',
    ),
    (
        'E062',
        'A2-FACR-ISOLATED-CLEAN',
        'configs/RGBNT201/ablations/t14_chain/a2_facr_isolated.yml',
        'E062_A2_facr_isolated_clean_RGBNT201_seed1111',
    ),
)
