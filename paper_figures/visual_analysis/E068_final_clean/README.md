...
- `fig_facr_routing.png`: mean routing weights for the three stages of the gradient-isolated ACI branch; the filename is retained only as a historical artifact name.
